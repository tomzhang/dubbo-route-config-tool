...
import vdian.router.tool.domain.VtraceInfo;
import vdian.router.tool.helper.VitaminHelper;
import vdian.router.tool.util.EnvEnum;
import vdian.router.tool.util.HttpClientUtil;
import vdian.router.tool.util.URLUtil;
import vdian.router.tool.xpath.XPathUtil;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import static vdian.router.tool.common.Constants.TRACE_INFO_FEILED_LENGHT;
import static vdian.router.tool.helper.VitaminHelper.*;
...
public class ToolEngine implements Engine {
    ...
    public String boss(String traceIdURL) throws Exception {
        ...
        for (VtraceInfo info : vtraceList) {
            ...
            // register vitamin
            register(info.getApp(), traceId, false);
        ...
        registerRoutes(traceId, JSON.toJSONString(routes));
    ...
    public void setEnv(String evn) throws VitaminException {
        ...
        VitaminHelper.vitaminClient = initVitaminClient(envEnum.getEnvInfo().getVitaminIp());
    }
